...
const SellerHeader: React.FC = () => {
  ...
  return (
    <header className="bg-white shadow-sm border-b border-gray-100">
      ...
      <div className="bg-indigo-600 text-white px-4 py-1.5">
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="bg-indigo-600 text-white p-2.5 rounded-xl shadow">
              <Store size={24} />
            </div>
            <div>
              <h1 className="text-lg font-bold text-gray-900">FastOrder & Pay</h1>
              <p className="text-xs text-gray-500">Espace Vendeur - Gestion des commandes</p>
            </div>
          </div>
